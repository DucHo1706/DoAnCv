...
function CandidateProfilePage() {
  ...
  const renderHistory = () => {
    ...
    if (applications.length === 0)
      return <EmptyState description="Bạn chưa ứng tuyển công việc nào." />;
        ...
        renderItem={(app) => (
          <List.Item>
            <Card
              ...
              extra={
                <Tag color={getClassificationColor(app.classification)}>{app.classification}</Tag>
              }
              ...
              <Row gutter={[16, 16]} align="middle">
                <Col span={8} style={{ textAlign: "center" }}>
                  <Progress
                    ...
                    size={80}
                    strokeColor={
                      app.aiScore >= 75 ? "#52c41a" : app.aiScore >= 50 ? "#faad14" : "#ff4d4f"
                    }
                    format={(percent) => (
                  ...
                  <div style={{ marginTop: 8 }}>
                    <Text type="secondary">Điểm AI</Text>
                  </div>
                </Col>
                <Col span={16}>
                  ...
                  >
                    {(() => {
                      const parsed = getParsedAnalysis(app);
                      return parsed?.summary || parsed?.score_analysis?.summary || app.aiReason || "Chưa có nhận xét từ AI";
                    })()}
                  </Paragraph>
                </Col>
              </Row>
                ...
                <Space direction="vertical" size={8} style={{ width: "100%" }}>
                  <div>
                    <Text type="success" strong>
                      <CheckCircleOutlined /> Điểm mạnh (Khớp JD):
                    </Text>
                  ...
                  <div>
                    <Text type="danger" strong>
                      <CloseCircleOutlined /> Điểm yếu (Thiếu sót):
                    </Text>
                    <div style={{ marginTop: 6 }}>
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col xs={24} md={8} lg={6}>
          ...
          >
            ...
            <Button type="primary" block style={{ marginTop: 24, borderRadius: 8 }}>
              Cập nhật thông tin
            </Button>
          </Card>
        </Col>
