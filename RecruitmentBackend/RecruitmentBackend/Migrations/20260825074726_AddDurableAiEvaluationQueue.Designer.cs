...
namespace RecruitmentBackend.Migrations
{
    ...
    [Migration("20260825074726_AddDurableAiEvaluationQueue")]
    partial class AddDurableAiEvaluationQueue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentBackend.Models.AiEvaluationTask", b =>
                {
                    b.Property<string>("AiEvaluationTaskID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RecruitmentBackend.Models.SkillObservation", b =>
                {
                    b.Property<long>("SkillObservationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("SkillObservationID"));
                    ...
                    b.HasKey("SkillObservationID");

                    b.HasIndex("LastObservedAtUtc");

                    b.HasIndex("Status", "NormalizedCandidate");

                    b.HasIndex("SourceType", "SourceEntityID", "NormalizedCandidate")
                        .IsUnique();

                    b.ToTable("SkillObservations");
                });
            ...
            modelBuilder.Entity("RecruitmentBackend.Models.TalentPoolCandidate", b =>
                {
                    ...
                    b.Property<string>("SourcingPriority")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourcingStage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TargetPositionsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RecruitmentBackend.Models.AiEvaluationTask", b =>
                {
                    b.HasOne("RecruitmentBackend.Models.Application", "Application")
                        .WithOne("AiEvaluationTask")
                        .HasForeignKey("RecruitmentBackend.Models.AiEvaluationTask", "ApplicationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
